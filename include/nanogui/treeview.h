 ...
 */
     ...
     */
        ...
        TreeView(Widget* parent, const std::vector<TreeNode>& items);
        ...
        void set_items(const std::vector<TreeNode>& items);
        /// The items associated with this Treeview.
        const std::vector<TreeNode>& items() const { return m_items; }
